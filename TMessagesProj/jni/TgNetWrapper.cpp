...
static const char *FileLoadOperationClassPathName = "ir/nogram/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "ir/nogram/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "ir/nogram/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILir/nogram/tgnet/RequestDelegateInternal;Lir/nogram/tgnet/QuickAckDelegate;Lir/nogram/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("ir/nogram/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/nogram/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/nogram/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/nogram/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("ir/nogram/tgnet/ConnectionsManager"));
