 ...
 * list
 * such that it can be bound to a {@link ir.nogram.messanger.support.widget.RecyclerView.Adapter
...
public class SortedList<T> {
    ...
    public static abstract class Callback<T2> implements Comparator<T2>, ListUpdateCallback {
         ...
         * <p>
         * For example, if you are using SortedList with a {@link ir.nogram.messanger.support.widget.RecyclerView.Adapter
