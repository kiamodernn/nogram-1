...
package ir.nogram.messanger.support.util;
...
public class DiffUtil {
    ...
    public abstract static class Callback {
         ...
         * {@link ir.nogram.messanger.support.widget.RecyclerView.Adapter RecyclerView.Adapter}, you should
         ...
         * {@link ir.nogram.messanger.support.widget.RecyclerView.ItemAnimator ItemAnimator} can use that
    ...
    public static class DiffResult {
         ...
         * <p>
         * For example, if you have an {@link ir.nogram.messanger.support.widget.RecyclerView.Adapter Adapter}
         ...
         * {@link ir.nogram.messanger.support.widget.RecyclerView.AdapterDataObserver AdapterDataObserver}
