...
import ir.nogram.messanger.exoplayer2.source.AdaptiveMediaSourceEventListener;
...
import ir.nogram.messanger.exoplayer2.source.dash.manifest.UtcTimingElement;
...
import ir.nogram.messanger.exoplayer2.upstream.ParsingLoadable;
...
public final class DashMediaSource implements MediaSource {
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
        ir.nogram.messanger.exoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      ir.nogram.messanger.exoplayer2.source.dash.manifest.Period period =
