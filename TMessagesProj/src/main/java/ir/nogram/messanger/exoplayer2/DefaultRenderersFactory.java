 ...
 */
package ir.nogram.messanger.exoplayer2;
...
import ir.nogram.messanger.exoplayer2.audio.AudioCapabilities;
import ir.nogram.messanger.exoplayer2.audio.AudioProcessor;
import ir.nogram.messanger.exoplayer2.audio.AudioRendererEventListener;
import ir.nogram.messanger.exoplayer2.audio.MediaCodecAudioRenderer;
import ir.nogram.messanger.exoplayer2.drm.DrmSessionManager;
import ir.nogram.messanger.exoplayer2.drm.FrameworkMediaCrypto;
import ir.nogram.messanger.exoplayer2.mediacodec.MediaCodecSelector;
import ir.nogram.messanger.exoplayer2.metadata.MetadataRenderer;
import ir.nogram.messanger.exoplayer2.text.TextRenderer;
import ir.nogram.messanger.exoplayer2.trackselection.TrackSelector;
import ir.nogram.messanger.exoplayer2.video.MediaCodecVideoRenderer;
import ir.nogram.messanger.exoplayer2.video.VideoRendererEventListener;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("ir.nogram.messanger.exoplayer2.ext.vp9.LibvpxVideoRenderer");
  ...
  protected void buildAudioRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("ir.nogram.messanger.exoplayer2.ext.opus.LibopusAudioRenderer");
    ...
    try {
      Class<?> clazz =
          Class.forName("ir.nogram.messanger.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
    ...
    try {
      Class<?> clazz =
          Class.forName("ir.nogram.messanger.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
