 ...
 */
package ir.nogram.messanger.exoplayer2.extractor;

import ir.nogram.messanger.exoplayer2.extractor.flv.FlvExtractor;
...
import ir.nogram.messanger.exoplayer2.extractor.mp4.Mp4Extractor;
import ir.nogram.messanger.exoplayer2.extractor.ogg.OggExtractor;
...
import ir.nogram.messanger.exoplayer2.extractor.ts.PsExtractor;
import ir.nogram.messanger.exoplayer2.extractor.ts.TsExtractor;
import ir.nogram.messanger.exoplayer2.extractor.wav.WavExtractor;
  ...
  static {
    ...
    try {
      flacExtractorConstructor =
          Class.forName("ir.nogram.messanger.exoplayer2.ext.flac.FlacExtractor")
