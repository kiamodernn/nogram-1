...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "ir.nogram.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "ir.nogram.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "ir.nogram.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "ir.nogram.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "ir.nogram.android.musicplayer.next";
