...
import ir.nogram.ui.Components.ForegroundDetector;
...
public class AndroidUtilities {
    ...
    //HoseinKord
    public static final int defColor =0xff58BCD5;
    ...
    public static SpannableStringBuilder replaceTags(String str, int flag) {
        try {
            ...
            for (int a = 0; a < bolds.size() / 2; a++) {
                spannableStringBuilder.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(ThemeManager.getFont())), bolds.get(a * 2), bolds.get(a * 2 + 1), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
    ...
    public static int getIntAlphaColor(String key, int def, float factor){
        SharedPreferences themePrefs = ApplicationLoader.applicationContext.getSharedPreferences(THEME_PREFS, Context.MODE_PRIVATE);
