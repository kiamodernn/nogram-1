...
import ir.nogram.ui.Components.URLSpanNoUnderlineBold;
    ...
    public void generateLayout(TLRPC.User fromUser) {
        ...
        if (messageText instanceof Spannable) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (entity instanceof TLRPC.TL_messageEntityBold) {
                    spannable.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(ThemeManager.getFont())), entity.offset, entity.offset + entity.length, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
