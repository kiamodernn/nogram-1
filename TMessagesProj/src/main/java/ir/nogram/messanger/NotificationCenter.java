...
public class NotificationCenter {
    ...
    //HoseinKord
    public static final int ghostRulesUpdated = totalEvents++;


    public static final int refreshTabs = totalEvents++;
    public static final int didReceivedpopUpMessage = totalEvents++;
    public static final int ghostUpdated = totalEvents++;

    public static final int didChangedColorTheme = totalEvents++;
    public static final int chatCreatedForFaveMessage = totalEvents++;
