...
import ir.nogram.messanger.time.FastDateFormat;
...
import ir.nogram.users.activity.helper.ConvertDate;
...
public class LocaleController {
    ...
    public static String formatDateChat(long date) {
        try {
            ...
            if(Language.isPersian()){
                return  ConvertDate.gregorian_to_jalali(dateYear , dateMonth, dateDayOfMonth) ;
            }
    ...
    public static String stringForMessageListDate(long date) {
        try {
            ...
            if(Language.isPersian()){
                return  ConvertDate.gregorian_to_jalali_dialog(date) ;
            }
