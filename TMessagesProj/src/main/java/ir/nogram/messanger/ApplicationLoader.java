...
import ir.nogram.users.activity.helper.OneSignalNotificationReceivedHandler;
...
public class ApplicationLoader extends Application {
    ...
    public static SharedPreferences sharedPreferencesMain ;
    ...
    public static File getFilesDirFixed() {
        ...
        return new File("/data/data/ir.nogram.messanger/files");
    }
    ...
    public void onCreate() {
        ...
        //HoseinKord
        sharedPreferencesMain = applicationContext.getSharedPreferences(Pref.MAIN , MODE_PRIVATE) ;
