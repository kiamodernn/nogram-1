...
public class DialogsAdapterLock extends RecyclerView.Adapter {
    ...
    public DialogsAdapterLock(Context context, int type) {
        mContext = context;
        dialogsType = type;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        if (viewHolder.getItemViewType() == 0) {
            ...
            if(ApplicationLoader.databaseHandler.islocked( (int) dialog.id)) {
                isLoced = true ;
            }else {
                isLoced = false ;
            }
