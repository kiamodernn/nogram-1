...
import ir.nogram.ui.Cells.TextInfoCell;
...
public class GhostUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {

    public interface GhostUsersActivityDelegate {
    ...
    private GhostUsersActivityDelegate delegate;

    private final static int block_user = 1;

    private int ghostType  ;
    public GhostUsersActivity(ArrayList<Integer> users, boolean group, boolean always , int type) {
        super();
        uidArray = users;
    ...
    public void setDelegate(GhostUsersActivityDelegate privacyActivityDelegate) {
