...
import ir.nogram.ui.AudioPlayerActivity;
import ir.nogram.ui.ChatActivity;
import ir.nogram.ui.ThemeManager;
import ir.nogram.ui.VoIPActivity;
...
public class FragmentContextView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateStyle(int style) {
        ...
        if (style == 0) {
            ...
            titleTextView.setTypeface(AndroidUtilities.getTypeface(ThemeManager.getFont()));
    ...
    private void checkPlayer(boolean create) {
        ...
        if (messageObject == null || messageObject.getId() == 0/* || !messageObject.isMusic()*/) {
            ...
            if (lastMessageObject != messageObject || prevStyle != 0) {
                ...
                TypefaceSpan span = new TypefaceSpan(AndroidUtilities.getTypeface(ThemeManager.getFont()), 0, Theme.getColor(Theme.key_inappPlayerPerformer));
