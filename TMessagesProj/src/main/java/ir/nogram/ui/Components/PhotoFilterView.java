...
import ir.nogram.ui.Cells.PhotoEditToolCell;
...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        for (int a = 0; a < 4; a++) {
            ...
            curveTextView[a].setTypeface(AndroidUtilities.getTypeface(ThemeManager.getFont()));
        ...
        tintShadowsButton.setTypeface(AndroidUtilities.getTypeface(ThemeManager.getFont()));
        ...
        tintHighlightsButton.setTypeface(AndroidUtilities.getTypeface(ThemeManager.getFont()));
