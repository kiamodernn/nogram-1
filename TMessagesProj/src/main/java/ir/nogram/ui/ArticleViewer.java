...
import ir.nogram.ui.Components.AnimatedFileDrawable;
import ir.nogram.ui.Components.AvatarDrawable;
import ir.nogram.ui.Components.ClippingImageView;
import ir.nogram.ui.Components.ContextProgressView;
...
import ir.nogram.ui.Components.Scroller;
import ir.nogram.ui.Components.SeekBar;
import ir.nogram.ui.Components.ShareAlert;
import ir.nogram.ui.Components.TextPaintSpan;
import ir.nogram.ui.Components.TextPaintUrlSpan;
import ir.nogram.ui.Components.TypefaceSpan;
import ir.nogram.ui.Components.VideoPlayer;
import ir.nogram.ui.Components.WebPlayerView;
...
public class ArticleViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    private void showPopup(View parent, int gravity, int x, int y) {
        ...
        if (popupLayout == null) {
            ...
            deleteView.setTypeface(AndroidUtilities.getTypeface(ThemeManager.getFont()));
            ...
            if ((flags & TEXT_FLAG_MONO) != 0) {
                ...
                if (selectedFont == 1 || parentBlock instanceof TLRPC.TL_pageBlockTitle || parentBlock instanceof TLRPC.TL_pageBlockHeader || parentBlock instanceof TLRPC.TL_pageBlockSubtitle || parentBlock instanceof TLRPC.TL_pageBlockSubheader) {
                    ...
                    if ((flags & TEXT_FLAG_MEDIUM) != 0 && (flags & TEXT_FLAG_ITALIC) != 0) {
                        ...
                        paint.setTypeface(AndroidUtilities.getTypeface(ThemeManager.getFont()));
                    } else if ((flags & TEXT_FLAG_ITALIC) != 0) {
                        paint.setTypeface(AndroidUtilities.getTypeface(ThemeManager.getFont()));
                    }
                }
    ...
    private StaticLayout createLayoutForText(CharSequence plainText, TLRPC.RichText richText, int width, TLRPC.PageBlock parentBlock) {
        ...
        if (parentBlock instanceof TLRPC.TL_pageBlockEmbedPost && richText == null) {
            ...
            if (channelNamePaint == null) {
                ...
                channelNamePaint.setTypeface(AndroidUtilities.getTypeface(ThemeManager.getFont()));
            }
    ...
    private void updatePaintFonts() {
        ...
        Typeface typefaceItalic = selectedFont == 0 ? AndroidUtilities.getTypeface(ThemeManager.getFont()) : Typeface.create("serif", Typeface.ITALIC);
        Typeface typefaceBold = selectedFont == 0 ? AndroidUtilities.getTypeface(ThemeManager.getFont()) : Typeface.create("serif", Typeface.BOLD);
            ...
            if (currentBlock != null) {
                ...
                if (!TextUtils.isEmpty(title) || !TextUtils.isEmpty(author)) {
                    ...
                    if (!TextUtils.isEmpty(author)) {
                        TypefaceSpan span = new TypefaceSpan(AndroidUtilities.getTypeface(ThemeManager.getFont()));
