...
public class DrawerProfileCell extends FrameLayout {
    ...
    public DrawerProfileCell(Context context) {
        ...
        timerTitle = new TextView(context);
        timerTitle.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 12);
        timerTitle.setLines(1);
        timerTitle.setMaxLines(1);
        timerTitle.setSingleLine(true);
        timerTitle.setGravity(Gravity.RIGHT);
        timerTitle.setVisibility(GONE);
        addView(timerTitle, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT,  18 , Gravity.RIGHT | Gravity.CENTER ));
        ...
        addView(timeTextView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT,  18 , Gravity.RIGHT | Gravity.CENTER ,0 ,18 , 0 , 0 ));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        timerTitle.setTextColor(Theme.getColor(Theme.key_chats_menuName));

        if (Theme.isCustomTheme() && backgroundDrawable != null) {
            phoneTextView.setTextColor(Theme.getColor(Theme.key_chats_menuPhone));
            shadowView.setVisibility(VISIBLE);
            timeTextView.setTextColor(Theme.getColor(Theme.key_chats_menuPhone));
            timerTitle.setTextColor(Theme.getColor(Theme.key_chats_menuPhone));
            ...
            timeTextView.setTextColor(Theme.getColor(Theme.key_chats_menuPhoneCats));
            timerTitle.setTextColor(Theme.getColor(Theme.key_chats_menuPhoneCats));
    ...
    public void setUser(TLRPC.User user) {
        ...
        timerTitle.setText(LocaleController.getString("TimeUse" , R.string.TimeUse));
