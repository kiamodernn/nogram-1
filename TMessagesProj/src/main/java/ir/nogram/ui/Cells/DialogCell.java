...
public class DialogCell extends BaseCell {
    ...
    public boolean hideAntiTab = false;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        setMeasuredDimension(MeasureSpec.getSize(widthMeasureSpec),hideAntiTab ? 0 : AndroidUtilities.dp(72) + (useSeparator ? 1 : 0));
...
//
    ...
    public static ArrayList<TLRPC.TL_dialog> getFaveList() {
        ...
        int sort = plusPreferences.getInt(HoldConst.Pref_sortFavs, 0);
        ...
        try {
            ...
            ArrayList<TLRPC.TL_dialog> dialogs = MessagesController.getInstance().dialogs;
...
//                    dialogs.remove(d) ;
        ...
        if(sort == 0){
            sortDefault(dialogsFave);
        }else{
            sortUnread(dialogsFave);
        }
        return dialogsFave;
    }
    ...
    private static void sortDefault(ArrayList<TLRPC.TL_dialog> dialogs){
    ...
    private static void sortUnread(ArrayList<TLRPC.TL_dialog> dialogs){
        Collections.sort(dialogs, new Comparator<TLRPC.TL_dialog>() {
            @Override
            public int compare(TLRPC.TL_dialog dialog1, TLRPC.TL_dialog dialog2) {
                if (!dialog1.pinned && dialog2.pinned) {
