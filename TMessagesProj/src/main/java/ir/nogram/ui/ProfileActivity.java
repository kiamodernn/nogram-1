...
import ir.nogram.ui.Components.AvatarUpdater;
...
import ir.nogram.ui.Components.IdenticonDrawable;
...
public class ProfileActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() {
            ...
            public boolean onItemClick(View view, int position) {
                if (position > emptyRowChat2 && position < membersEndRow) {
                    ...
                    items.add(LocaleController.getString("ShowMessagesJustFromThisUser", R.string.ShowMessagesJustFromThisUser)) ;
                    actions.add(3) ;
                    if (items.isEmpty()) {
                        return false;
                    }
        ...
        for (int a = 0; a < 2; a++) {
            ...
            nameTextView[a].setTypeface(AndroidUtilities.getTypeface(ThemeManager.getFont()));
    ...
    private void createUserAvatarMenu()
    {
        ...
        localArrayList1.add(LocaleController.getString("ShowMessagesJustFromThisUser", R.string.ShowMessagesJustFromThisUser));
        builder.setItems((CharSequence[])localArrayList1.toArray(new CharSequence[localArrayList1.size()]),
...
//        localBuilder.setTitle(LocaleController.getString("User", R.));
        showDialog(builder.create());
    }
    private void  showJustFromuser(int user_id){
        Bundle bundle = new Bundle();
        bundle.putInt("chat_id", currentChat.id);
        bundle.putInt("just_from_id", user_id);
